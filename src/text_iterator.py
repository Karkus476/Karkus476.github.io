...
class TextIterator:
    ...
    def __init__(self, text):
        ...
        self.index = 0
        self.accepted = ""
        # The length of the most recently ignored or accepted string/regex match.
        self.recent = ""
        self.done = False
    ...
    def revert(self):
        """Revert the most recent accepted/ignored string/regex pattern"""
